...
[`@aws-sdk/client-accessanalyzer`](https://www.npmjs.com/package/@aws-sdk/client-accessanalyzer/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-accessanalyzer@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rKmG72lTOpem8APb7Fr1g2qeooW0r+HDDs+IdkIerSU+wJBVRiXX5FUtN+EpbqeL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-accessanalyzer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-accessanalyzer@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-accessanalyzer@3.741.0/index.min.mjs": "sha384-rKmG72lTOpem8APb7Fr1g2qeooW0r+HDDs+IdkIerSU+wJBVRiXX5FUtN+EpbqeL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-accessanalyzer/blob/refs/tags/3.741.0/LICENSE
```
